 ...
 */
function DownloadKeywordsReportExample(AdWordsUser $user, $filePath) {
  ...
  $selector->fields = array('CampaignId', 'AdGroupId', 'Id', 'Criteria','Impressions', 'Clicks', 'Cost');
  ...
  $reportDefinition->reportName = 'Keywords performance report #' . uniqid();
...
try {
  ...
  // Run the example.
  DownloadKeywordsReportExample($user, $filePath);
} catch (Exception $e) {
